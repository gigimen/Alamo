...
CREATE   PROCEDURE [GeneralPurpose].[usp_DOSGroup_PushNotification] 
@cardid INT ,
...
*/
	SELECT @xmlvalues = SQLWebAPI.asm_DOSGroup_PushNotification(
	   @UserKey
	  ,@password
	  ,@token
	  ,@cardid
	...
	VALUES (@cardid,'PushNotification',@xmlvalues)
