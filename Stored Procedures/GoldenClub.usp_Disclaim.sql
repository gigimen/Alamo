...
CREATE       PROCEDURE [GoldenClub].[usp_Disclaim]
@CustID 		int,
@UserAccessID	int,
...
begin
	raiserror('Invalid CustomerID (%d) specified or Customer is not part of GoldenClub or has already disclaimed',16,1,@CustID)
	return (2)
end
