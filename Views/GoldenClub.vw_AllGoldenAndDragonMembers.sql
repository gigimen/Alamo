...
CREATE VIEW [GoldenClub].[vw_AllGoldenAndDragonMembers]
WITH SCHEMABINDING
AS
SELECT  c.CustomerID,
	c.LastName, 
	...
	GeneralPurpose.fn_UTCToLocal(1,g.MembershipTimeStampUTC) AS MemberFrom,
	...
	CASE WHEN g.GoldenParams & 4096 = 4096 THEN 1	ELSE 0	END AS IsCinaScrock,
	g.MemberTypeID,
...
--	gc2.CardTypeID		AS PersonalCardTypeID,
...
--	gcs2.FDescription 	AS PersonalCardStatus,
	...
	s.FName AS fromPC,
	g.Categoria,
	getdate() as ConsegnaLettera, --for backward compatibility,
...
FROM   GoldenClub.tbl_Members g
	...
	LEFT OUTER JOIN GoldenClub.tbl_MemberTypes mt ON mt.MemberTypeID = g.MemberTypeID
