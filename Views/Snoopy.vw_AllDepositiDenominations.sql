...
CREATE  VIEW [Snoopy].[vw_AllDepositiDenominations]
WITH SCHEMABINDING
AS
SELECT 
	Snoopy.tbl_Depositi.DepositoID	,
	Snoopy.tbl_Depositi.PrelevCustTransID									AS DepOnTransID	, 
	DepLF.LifeCycleID													AS DepOnLFID,
    DepLF.GamingDate 													AS DepOnGamingdate,
	Dep.CustomerTransactionTime											AS DepOnTimeUTC, 
	GeneralPurpose.fn_UTCToLocal(1,Dep.CustomerTransactionTime)	AS DepOnTimeLoc, 
--	Dep.OperationID 		,
    ...
    (DepValues.Quantity * DepDenos.Denomination) AS Importo,
