...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [GeneralPurpose].[fn_CloseTableOnCISDisplay](@tablename [NVARCHAR](4000))
...
--	SELECT @ret = [GeneralPurpose].[asm_OpenCloseTable] (0,@table,'','10.41.41.8',1000)
	SELECT @ret = [GeneralPurpose].[asm_SendToCIS] (
	'TABLENAME="' + @table + '" EXC="CIS000" STATUS="CLOSED"',-- GAMETYPE="AR"',
	  @ip,--'10.41.41.8'
	  @port--,1000
	  )
	RETURN @ret
